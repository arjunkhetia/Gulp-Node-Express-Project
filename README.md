# Gulp-Node-Express Project   ![Version][version-image]
...
The quickest way to get start with Gulp, Node.Js & Express, just clone the project:

```bash
$ git clone https://github.com/arjunkhetia/Gulp-Node-Express-Project.git
```
...
Start app with gulp at `http://localhost:3000/`:
...
![Monitoring Page](https://github.com/arjunkhetia/Gulp-Node-Express-Project/blob/master/public/status-monitor.png "Monitoring Page")
